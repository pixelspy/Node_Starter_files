...
// strategy : an interface that checks the credentials
...
exports.forgot = async (req, res) => {
  ...
  await user.save(); // wait until the user is saved
...
exports.reset = async (req, res) => {
  ...
  // if there is a user, show th reset password form
  console.log(user); // test if we manage to find user token !
  res.render('reset', {title: 'Reset Your Password'});

};

exports.confirmedPasswords = (req, res, next) => {
  if (req.body.password === req.body['password-confirm']) { //req.body.password-confirm
    next();
    return;
  }
